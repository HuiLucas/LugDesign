...
def TradeOff(design_array2):
    for design in design_array2:
        ...
        print(f"nut type: {design.fasteners.nut_type}, hole type: {design.fasteners.hole_type}, material: {design.fasteners.material}, bolt type: {design.fasteners.type_bolt}")
        print(f"mass: {design.mass}")
        print(f"MS: {design.MS}")
        print("")
